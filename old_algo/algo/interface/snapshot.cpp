...
void Snapshot::readTenantsRestrictions() {
	...
	readVmVmAffinity(vm_vm_affinity);

	qDebug() << "readVmVmAntiAffinity START";
	readVmVmAntiAffinity(vm_vm_anti_affinity);
...
void Snapshot::readVmVmAffinity(const QDomElement & vm_vm_affinity) {
...
void Snapshot::readVmVmAntiAffinity(const QDomElement & vm_vm_anti_affinity) {
